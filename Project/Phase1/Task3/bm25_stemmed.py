...
# parse_directory_files_stopped(source_path, stopped_parsed_docs_path,stopwords())
...
topHitsTupTup = searchListOfQueries(get_stemmed_queries(),100);
topHitsDictToTxtFile(topHitsTupTup,bm25_stemmed_file)
